...
#### AMP
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC) 
Amplificator. See [[Shape](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SHAPE)](#SHAPE).

#### AMPLITUDE 
##### Contextual to [[VCA](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VCA)](#VCA)
Base output gain. 

#### ARPEGGIATOR_ARP
##### Contextual to [[Part Global](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#PART_GLOBAL)](#PART_GLOBAL)
...
#### AUDIO
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC)
Continuous colored noise — beds, wind, breath, filter excitation. See [[Shape](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SHAPE)](#SHAPE).

### B

#### BEHAVIOR
##### Contextual to [[Panner](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#PAN)](#PAN)
...
#### BIPOLR
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC) 
See [[Polarity_bipolr](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#POLARITY_BIPOLR)](#POLARITY_BIPOLR).

#### BP
##### Contextual to [[Filter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#FILTER_FLT)](#FILTER_FLT)
...
#### CHRD_CHORD
##### Contextual to [[Part Global](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#PART_GLOBAL)](#PART_GLOBAL)
Voice mode. Pressing a single key triggers an entire predefined chord rather than just a single note. The played note is the root; intervals add on top. Each chord tone consumes a [[voice](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VOICE)](#VOICE), so a MAJ7 chord uses four voices per key. 
...
#### CLICK :
See **[[Toggle.](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#TOGGLE)](#TOGGLE)**
...
#### DENSITY_DENS 
See [[Rate](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#RATE)](#RATE).

#### DETUNE
##### Contextual to [[Oscillator](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#OSCILLATOR_OSC)](#OSCILLATOR_OSC)
See [[Pitch](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#PITCH)](#PITCH).
...
* VOICES (Density) : The number of [[voices](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VOICE)](#VOICE) in the strum.
* DRIFT (Pitch) : Pitch drift added for each successive voice, to simulate human-style strumming detuning.

#### DRIFT
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC)
Type of [[Source](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SOURCE_SRC)](#SOURCE_SRC). This operates strictly in the sub-audio domain, providing slow, wandering modulation over seconds or minutes.
...
#### DUST
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC)
Sparse, randomly timed discrete impulses or clicks. Rather than a wash of noise, it sounds like a Geiger counter, static electricity, or the crackle of a worn vinyl record. See [[Shape](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SHAPE_SHPE)](#SHAPE_SHPE).
...
#### EVOLUTION
Macro depth of the [[LFO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LFO)](#LFO). Depth of the drift layer (filtered chaos).
...
- **Character string** : A 4-way radio button strip across the top.
    - _Values:_ [`[LP](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LP)`](#LP) (Low-pass), [`[BP](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#BP)`](#BP) (Band-pass), [`[HP](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#HP)`](#HP) (High-pass), [`[NCH](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#NCH)`](#NCH) (Notch).
...
- [**[Slope Badge](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SLOPE)**](#SLOPE): A click-cycle handle box in the top-right corner of the canvas to select the filter slope. 
...
#### FM_DEPTH
##### Contextual to [[Oscillator](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#OSCILLATOR/OSC)](#OSCILLATOR/OSC)

#### FREQUENCY
##### Contextual to [[Filter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#FILTER/FLT)](#FILTER/FLT)
Cutoff frequency. Logarithmic scale from `20Hz` to `20.0k`.
##### Contextual to [[LFO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LFO)](#LFO)
See [[Rate](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#RATE)](#RATE).
...
##### Contextual to [[Oscillator](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#OSCILLATOR_OSC)](#OSCILLATOR_OSC)
See [[Output](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#OUTPUT)](#OUTPUT).

#### LFO
**Graph node.** A multi-scale low-frequency oscillator—a “temporal synthesis engine” that generates three layers of modulation ([[meso](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#RYTHM)](#RYTHM), [[micro](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#TEXTURE)](#TEXTURE), [[macro](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EVOLUTION)](#EVOLUTION)) from a single shared phase, with organic chaotic drift and per-key synchronization. It shares the oscillator’s phase mechanism while adding an output with multiple levels of depth.
...
#### MAIN
##### Contextual to [[Mixer](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#MIXER_MIX)](#MIXER_MIX)
Output gain. 
#### MAPPED ROTARIES 
...
#### MIXER_MIX
Graph node. Usually auto-injected by the [[DAG](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#DAG)](#DAG) compiler when edges converge, rather than placed manually.
...
#### MODULATION 
##### Contextual to [[Oscillator](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#OSCILLATOR_OSC)](#OSCILLATOR_OSC)
Knob [[FM DEPTH](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#FM_DEPTH)](#FM_DEPTH). **FM Depth** dictates the intensity of the frequency modulation being applied to an oscillator.
...
#### MUTE
##### Contextual to [[VCA](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VCA)](#VCA)
See [[State](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#STATE)](#STATE).
##### Contextual to [[Mixer](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#MIXER_MIX)](#MIXER_MIX)
...
#### OSCILLATOR_OSC
Graph node. The primary tone generator with six [[waveforms](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#WAVEFORM)](#WAVEFORM), linear FM, pulse-width control, per-read detune, and intrinsic pitch glide.
...
* **Engine Modes :** [[MONO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#MONO)](#MONO), [[LGT (Legato)](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LGT_LEGATO)](#LGT_LEGATO), [[POLY](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#POLY)](#POLY), [[UNI (Unison)](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#UNI_UNISON)](#UNI_UNISON), [[DUO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#DUO)](#DUO), [[CHRD (Chord)](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#CHRD_CHORD)](#CHRD_CHORD), [[DLY (Delay strum)](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#DLY_or_DELAY_STRUM)](#DLY_or_DELAY_STRUM) and [[ARP (Arpeggiator)](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#ARPEGGIATOR_ARP)](#ARPEGGIATOR_ARP)
...
#### QUANT
Sample & hold quantized, random wevaform. A noise quantized following some musical grid. See [[Shape](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SHAPE-SHPE)](#SHAPE-SHPE).
...
#### RYTHM
Meso depth of the [[LFO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LFO)](#LFO). 
...
#### SLEW
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC)
See [[Shape](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SHAPE_SHPE)](#SHAPE_SHPE).
##### Contextual to [[LFO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LFO)](#LFO)
...
#### STEPS 
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC)
See [[Shape](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#SHAPE/SHPE)](#SHAPE/SHPE).

#### SYNC
##### Contextual to [[Exciter](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#EXCITER_EXC)](#EXCITER_EXC)
See [[Clock](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#CLOCK)](#CLOCK).

### T

#### TACTILE DRAG 
See [**[Knobs](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#KNOBS)**](#KNOBS).
...
#### TEXTURE
Micro depth of the [[LFO](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#LFO)](#LFO). 
...
#### UNI_UNISON
##### Contextual to [[Part Global](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#PART_GLOBAL)](#PART_GLOBAL)
Voice mode. Takes some or all available [[voices](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VOICE)](#VOICE) and stacks them onto a single keypress. The voices are often slightly detuned from one another to create a massive, thick, and wide sound. 
* VOICES (DENSITY) : increases the number of [[voices](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VOICE)](#VOICE) per key. 
* SPREAD (DETUNE) : increases the pitch difference between each [[voices](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#VOICE)](#VOICE).
...
#### WIDTH
##### Contextual to [[Oscillator](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#OSCILLATOR_OSC)](#OSCILLATOR_OSC)
See [[Timbre](https://github.com/realdocfx/gdvp-manual/wiki/glossary/_edit#TIMBRE)](#TIMBRE).